...
fn get_input_values(count: i32, want_sorted: bool) -> Vec<u32> {
    let mut prng = thread_rng();
    let mut values = (0..count).map(|_| prng.gen::<u32>()).collect::<Vec<_>>();
    if want_sorted {
