...
fn insert(c: &mut Criterion) {
    ...
    for count in [1, 10, 100, 1_000, 10_000].iter() {
        ...
        group.bench_with_input(
            ...
            |b, &count| {
                let values = get_input_values(count, false);
                b.iter(|| values.iter().copied().collect::<RoaringLazy>());
            },
        );
        group.bench_with_input(
